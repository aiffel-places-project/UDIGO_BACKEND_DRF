        ...
        try:
            ...
            if social_type == 'kakao':
                ...
                if valid_result['code'] == 200:
                    ...
                    return Response({'MESSAGE': valid_result['message']}, status=status.HTTP_400_BAD_REQUEST)
                ...
                return Response({'MESSAGE': 'INVALID_SOCIAL_TYPE'}, status=status.HTTP_400_BAD_REQUEST)
